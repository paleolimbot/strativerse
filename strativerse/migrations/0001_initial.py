# Generated by Django 2.1.3 on 2018-11-18 16:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geo_type', models.CharField(blank=True, max_length=55)),
                ('recursive_depth', models.IntegerField(default=0, editable=False)),
                ('name', models.CharField(max_length=255)),
                ('type', models.CharField(choices=[('water_body', 'Water Body'), ('glacier', 'Glacier'), ('bog', 'Bog'), ('geopolitical_unit', 'Geopolitical Unit'), ('region', 'Region')], max_length=55)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('assisted', 'Assisted'), ('collected', 'Collected'), ('funded', 'Funded'), ('analyzed', 'Analyzed'), ('published', 'Published'), ('maintains', 'Maintains')], max_length=55)),
                ('order', models.IntegerField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('refers_to', 'Refers to'), ('contains_data_from', 'Contains data from')], max_length=55)),
