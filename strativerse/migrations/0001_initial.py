# Generated by Django 2.1.3 on 2018-12-19 03:05
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key', models.CharField(max_length=55, validators=[django.core.validators.RegexValidator('^[A-Za-z0-9_.-]+$', message='Must only contain alphanumerics, the dash, period, or underscore')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('geometry', django.contrib.gis.db.models.fields.GeometryField(blank=True, srid=4326)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255)),
                ('slug', models.CharField(max_length=255, unique=True, validators=[django.core.validators.RegexValidator('^[^/][a-zA-Z0-9_/-]+[^/]$')])),
                ('description', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('published', models.CharField(choices=[('published', 'Published'), ('draft', 'Draft')], default='draft', max_length=55)),
                ('description', models.TextField(blank=True)),
                ...
                ('position_units', models.CharField(blank=True, default='cm', max_length=55)),
                ('geometry', django.contrib.gis.db.models.fields.GeometryField(blank=True, srid=4326)),
                ('geo_elev', models.FloatField(default=0)),
                ('geo_error', models.FloatField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('units', models.CharField(blank=True, max_length=55)),
