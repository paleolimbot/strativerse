# Generated by Django 2.1.3 on 2018-11-18 19:46
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('sediment_core', 'Sediment Core'), ('ice_core', 'Ice Core'), ('peat_core', 'Peat Core'), ('water_sample', 'Water Sample'), ('section', 'Section')], max_length=55)),
            ],
            options={
                'ordering': ['date'],
            },
        ...
        migrations.CreateModel(
            name='RecordFeatureRelation',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('relationship', models.CharField(choices=[('intersects', 'Intersects')], default='intersects', max_length=55)),
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='record_relation', to='strativerse.Feature')),
                ('record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='feature_relation', to='strativerse.Record')),
            ],
        ),
        migrations.CreateModel(
